...
public class RedisUtil implements ApplicationContextAware {
	...
	public static long incr(String key, long delta) {
		...
		return Convert.toLong(redisTemplate.opsForValue().increment(key, delta));
	}
	...
	public static long sSet(String key, Object... values) {
		try {
			return Convert.toLong(redisTemplate.opsForSet().add(key, values));
		} catch (Exception e) {
			e.printStackTrace();
			return 0;
		}
	...
	public static long sGetSetSize(String key) {
		try {
			return Convert.toLong(redisTemplate.opsForSet().size(key));
		} catch (Exception e) {
			e.printStackTrace();
			return 0;
		}
	...
	public static long setRemove(String key, Object... values) {
		try {
			return Convert.toLong(redisTemplate.opsForSet().remove(key, values));
		} catch (Exception e) {
			e.printStackTrace();
			return 0;
		}
	...
	public static long lGetListSize(String key) {
		try {
			return Convert.toLong(redisTemplate.opsForList().size(key));
		} catch (Exception e) {
			e.printStackTrace();
			return 0;
		}
	...
	public static long lRemove(String key, long count, Object value) {
		try {
			return Convert.toLong(redisTemplate.opsForList().remove(key, count, value));
		} catch (Exception e) {
			e.printStackTrace();
			return 0;
		}
