...
import top.kthirty.core.tool.support.RandomType;
import top.kthirty.core.tool.support.StrFormatter;
import top.kthirty.core.tool.support.StrSplitter;
...
public class StringUtil extends org.springframework.util.StringUtils {
	 ...
	 * @param num 长度
	 * @param c 补全字符
	 * @param before 是否在首位补充（true：首，false：尾）
	 * @return 补全后的字符
	 */
	public static String supplement(String s,int num,char c,boolean before){
		if(s.length() < num){
	...
	public static String getContainsStr(CharSequence str, CharSequence... testStrs) {
		if (ObjectUtils.isEmpty(str) || Func.isEmpty(testStrs)) {
			return null;
		}
	...
	public static String underlineToHump(String para) {
		return charlineToHump(para,"_");
	}
	/**
	 * 指定字符转驼峰
	 * charlineToHump("aa_bb_cc","_") = aaBbCc
	 * charlineToHump("aa-bb-cc","-") = aaBbCc
	 *
	 * @param para 字符串
	 * @param c 分隔符
	 * @return String
	 */
	public static String charlineToHump(String para,String c){
