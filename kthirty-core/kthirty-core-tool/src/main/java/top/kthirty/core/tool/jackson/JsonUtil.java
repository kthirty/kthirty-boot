...
import top.kthirty.core.tool.utils.DateUtil;
import top.kthirty.core.tool.utils.Exceptions;
...
public class JsonUtil {
	...
	public static class JacksonObjectMapper extends ObjectMapper {
		...
		public JacksonObjectMapper(JacksonObjectMapper src){
			super(src);
		}
		public JacksonObjectMapper() {
			...
			//反序列化时，属性不存在的兼容处理s
			DeserializationConfig deserializationConfig = super.getDeserializationConfig().withoutFeatures(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
			//日期格式化
			super.registerModule(new KthirtyJavaTimeModule());
			super.findAndRegisterModules();
		}
